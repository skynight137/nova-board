  ...
  while IFS=$'\t' read -r commit subject; do
    case "$commit" in
      d3528e125828dc2721b1039b7d3eb9645266afc9)
        message="chore: initialize Aurora EQ project"
        ;;
      ...
      4fd5130e77dd975286e4c2d48991d8dc3cb4c52c)
        message="docs: add Aurora EQ migration design specification"
        ;;
      835b69c58358b909289e73bfefb54ee6d474b8af)
        message="docs: add Aurora EQ migration plan for 2026"
        ;;
      ...
      a24d8dfe4e1f099b9b8302c692df91fd6e6b7937)
        message="docs: reconcile Aurora EQ migration context"
        ;;
      8c27134b411b930172413827b4e2845a1e8ea7e7)
        message="docs: mark Aurora EQ migration plan complete"
        ;;
...
case "$GIT_COMMIT" in
  d3528e125828dc2721b1039b7d3eb9645266afc9) echo "chore: initialize Aurora EQ project" ;;
  ...
  4fd5130e77dd975286e4c2d48991d8dc3cb4c52c) echo "docs: add Aurora EQ migration design specification" ;;
  835b69c58358b909289e73bfefb54ee6d474b8af) echo "docs: add Aurora EQ migration plan for 2026" ;;
  ...
  a24d8dfe4e1f099b9b8302c692df91fd6e6b7937) echo "docs: reconcile Aurora EQ migration context" ;;
  8c27134b411b930172413827b4e2845a1e8ea7e7) echo "docs: mark Aurora EQ migration plan complete" ;;
