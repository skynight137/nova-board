...
- Tools row with clipboard, hotkeys, translation, voice, search, and more
...
- Image clipboard paste is currently a toast until `commitContent` and a
  `FileProvider` are wired for target-app URI permissions.
