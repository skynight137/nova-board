...
Pull-request jobs now always build and upload an unsigned debug APK. Release
keystore files and signing credentials are limited to the protected release
workflow.